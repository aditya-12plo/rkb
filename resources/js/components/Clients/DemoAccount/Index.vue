...
<div class="col-md-12 padding-5">
 ...
 <div class="col-sm-12 col-md-6">
                            <div class="dataTables_length" id="zero_configuration_table_length">
                                <div class="row row-xs">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button type="button" class="btn btn-info m-1"  @click="createItem()"><i class="fa fa-plus"></i> Tambah Akun Demo</button>
                                    </div>
                                </div> 
                            </div>
                        </div> 
  ...
  <vuetable ref="vuetable"
        api-url="/clients-area/get-list-demo-account"
        :fields="fields"
        pagination-path=""
        :per-page="perPage"
        :css="css.table"
...
export default {
  ...
  methods: {
    ...
    createItem() {
      axios.get('/clients-area/get-user-demo-account', this.forms).then(response => {
        if(!response.data){ 
