...
<div class="panel box-shadow-none content-header">
  <div class="panel-body">
    <div class="col-md-12">
      ...
      <h4 class="animated fadeInLeft" style="text-align:center;font-size: 2em;">Langkah 7</h4>
    </div>
  </div>
</div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-lg-12">
               <table class="table table-striped table-bordered" width="100%" cellspacing="0">
                 <tr>
                    <td colspan="3" style="text-align:center;"><b>DATA PEKERJAAN NASABAH</b></td>
                </tr>
<tr>
...
<div class="form-group col-lg-12">
    ...
    <button class="btn btn-info pd-x-20" type="submit">Langkah 8</button> 
</div>
...
export default {
  ...
  methods: {
    ...
    this.loading();
        ...
        axios.get('/clients-area/create-real-account/step/7/'+this.idCode).then((response) => {
            if(!response.data){ 
    ...
    submitData(){
      ...
      no_telp_kantor:this.forms.no_telp_kantor,no_faksimili:this.forms.no_faksimili, status:this.forms.status,pekerjaan_others:this.pekerjaan_others};
            axios.post('/clients-area/post-real-account/step-7',data).then(response => {
                if(!response.data){ 
                  window.location.href = window.webURL; 
                }else{ 
                  if(response.data.status == 200){
                        ...
                        this.$router.push({name:'addRealAccount8', params: {idnya:this.diacak(response.data.data.id)}});
                    }else{
