...
<div class="panel box-shadow-none content-header">
  <div class="panel-body">
    <div class="col-md-12">
      ...
      <h4 class="animated fadeInLeft" style="text-align:center;font-size: 2em;">Langkah 11</h4>
    </div>
  </div>
</div>
...
<div class="form-group col-lg-12">
    ...
    <button class="btn btn-info pd-x-20" type="submit">Langkah 12</button> 
</div>
...
export default {
  ...
  methods: {
    ...
    this.loading();
        ...
        axios.get('/clients-area/create-real-account/step/11/'+this.idCode).then((response) => {
            if(!response.data){ 
            ...
            axios.post('/clients-area/post-real-account/step-11', data).then(response => {
                if(!response.data){ 
                  ...
                  if(response.data.status == 200){
                        ...
                        this.$router.push({name:'addRealAccount12', params: {idnya:this.diacak(response.data.data.id)}});
                    }else{
