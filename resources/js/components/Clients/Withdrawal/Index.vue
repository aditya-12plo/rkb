...
<div class="panel box-shadow-none content-header">
  <div class="panel-body">
    <div class="col-md-12">
      <h3 class="animated fadeInLeft" style="text-align:center;font-size: 3em;">Riwayat Withdrawal</h3>
    </div>
  </div>
</div>
...
<div class="col-md-12 padding-5">
 ...
 <div class="col-sm-12 col-md-6">
                            <div class="dataTables_length" id="zero_configuration_table_length">
                                <div class="row row-xs">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button type="button" class="btn btn-info m-1"  @click="createItem()"><i class="fa fa-plus"></i> Ajukan Withdrawal </button>
                                    </div>
                                </div> 
                            </div>
                        </div> 
  ...
  <vuetable ref="vuetable"
        api-url="/clients-area/get-withdrawal"
        :fields="fields"
        pagination-path=""
        :per-page="perPage"
        :css="css.table"
...
<!-- @create --->
        ...
        <template slot="header"><h4 style="text-align:center;"> Pengajuan Withdrawal</h4></template>
        <template slot="body" >
...
export default {
  ...
  methods: {
    ...
    addItem(){
        ...
        masuk.set('total_withdrawal', this.total_withdrawal)

        axios.post('/clients-area/post-withdrawal' , masuk).then(response => {
            if(!response.data){ 
