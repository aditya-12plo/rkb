...
<div class="panel box-shadow-none content-header">
  <div class="panel-body">
    <div class="col-md-12">
      <h3 class="animated fadeInLeft" style="text-align:center;font-size: 3em;">Perubahan Password</h3>
    </div>
  </div>
</div>
    ...
    submitData(){
      this.$swal({
        ...
        confirmButtonText: 'Yes!'
          ...
          if (result.value) {
            axios.post('/clients-area/user/change-password', this.forms).then(response => {
                if(!response.data){ 
