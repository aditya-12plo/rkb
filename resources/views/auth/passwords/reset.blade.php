...
<div id="login" class="register-form d-flex flex-row justify-content-center align-items-center">
            ...
            @endif
                ...
                <div class="title-form"><h3 class="reg-title">Reset Password</h3></div>
                ...
                <input type="hidden" name="token" value="{{ $token }}">
                    <div class="login-main-form">
                        ...
                        <input id="password" class="input-stl" name="password" placeholder="Password" type="password" required="">
                        @if ($errors->has('password'))
                                        <span class="help-block">
                                            <p class="error" style="color:#FFBABA;"><strong> {{ $errors->first('password') }} </strong></p>
                                        </span>
                        @endif
  
                        <input id="password-confirm" class="input-stl" name="password_confirmation" placeholder="Konfirmasi Password" type="password" required="">
                        @if ($errors->has('password_confirmation'))
                                        <span class="help-block">
                                            <p class="error" style="color:#FFBABA;"><strong> {{ $errors->first('password_confirmation') }} </strong></p>
                                        </span>
                        @endif
                        <div class="login-btn-wrapp">
                            <button automation-id="login-sts-btn-sign-in" class="">Reset Password</button>
                        </div>
