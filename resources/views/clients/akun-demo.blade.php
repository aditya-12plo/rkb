...
@section('content-client')
    <div class="panel box-shadow-none content-header">
        <div class="panel-body">
            <div class="col-md-12">
                <h3 class="animated fadeInLeft" style="text-align:center; font-size:3em; ">List Akun Demo</h3>
            </div>
        </div>
    </div>
                        ...
                        <div id="zero_configuration_table_length" class="dataTables_length">
                            <div class="row row-xs">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <button type="button" class="btn btn-info m-1"><i class="fa fa-plus"></i>@if(Config::get('app.locale') == 'id')  Tambah Akun Demo @elseif(Config::get('app.locale') == 'cn') 添加模拟账户 @else Add Demo Account @endif</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <table id="realaccount_table" class="display table table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th>@if(Config::get('app.locale') == 'cn') 登录ID @else ID Login @endif</th>
                            <th>@if(Config::get('app.locale') == 'cn') 密码ID @else ID Password @endif</th>
