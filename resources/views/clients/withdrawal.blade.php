...
@section('content-client')
    <div class="panel box-shadow-none content-header">
        <div class="panel-body">
            <div class="col-md-12">
                <h3 class="animated fadeInLeft" style="text-align:center; font-size:3em; ">@if(Config::get('app.locale') == 'id') Riwayat Withdrawal @elseif(Config::get('app.locale') == 'cn') 提款历史 @else Withdrawal History @endif</h3>
            </div>
        </div>
    </div>
                        ...
                        <div id="zero_configuration_table_length" class="dataTables_length">
                            <div class="row row-xs">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <button type="button" class="btn btn-info m-1"><i class="fa fa-plus"></i>@if(Config::get('app.locale') == 'id')  Ajukan Withdrawal @elseif(Config::get('app.locale') == 'cn') 提款 @else Submit Withdrawal  @endif</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <table id="realaccount_table" class="display table table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th>@if(Config::get('app.locale') == 'id') Jumlah Withdrawal @elseif(Config::get('app.locale') == 'cn') 提款金额 @else Withdrawal Amount @endif</th>
